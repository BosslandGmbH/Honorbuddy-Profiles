...
* Get Honorbuddy set up and working
* Get Subversion set up and working
* Obtain a copy of Kick's profiles through Subversion
...
of providing the The Loremaster achievement
(http://www.wowhead.com/achievement=7520).  We have made much progress
in this regard, but the goal is still in the distance.


Setting up Honorbuddy
---------------------
There is a wealth of information to get you off-and-away using Honorbuddy.  You can find this
information in the Guides forum (http://www.thebuddyforum.com/honorbuddy-forum/honorbuddy-guides/).
Of particular interest to newcomers will be this information:

* Tony's "A quick Hb guide/presentation for a fast setup"
...
* Support forum
	...
	Make a post here, if you are having problems setting things up.  Be certain to describe
	the observed problem, and _attach_your_full_Honorbuddy_log_ that demonstrates the problem.
...
and discusses the simple process:
...
Happy questing!
Kickazz & The BosslandGmbH staff